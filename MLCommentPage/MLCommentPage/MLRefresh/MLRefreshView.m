...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.strokeColor =[UIColor colorWithRed:221 green:0 blue:0 alpha:1.0].CGColor;
...
- (CABasicAnimation *)rotateAnimation {
    if (!_rotateAnimation) {
        ...
        _rotateAnimation.fromValue = @(DEGREES_TO_RADIANS(30) + DRAW_LING_ROTATE);
        _rotateAnimation.toValue = @(M_PI + DEGREES_TO_RADIANS(30) + DRAW_LING_ROTATE);
